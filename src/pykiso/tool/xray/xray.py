...
class XrayPublisher:
    ...
    def publish_xml_result(
        ...
        if test_execution_name is None:
            return self._publish_xml_result(data=data, project_key=project_key, test_execution_id=test_execution_id)
    ...
    def _publish_xml_result(self, data: dict, project_key: str, test_execution_id: str | None = None) -> dict[str, str]:
