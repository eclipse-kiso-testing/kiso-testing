...
def test_reformat_xml_results_with_parameterized_tests():
    test_results = {
        ...
        "tests": [
            ...
            {"testKey": "TEST-1", "comment": "test_case_1: Failed execution", "status": "FAILED"},
        ],
    }
    ...
    expected_result = [
        {
            "info": {
                "summary": "Test Execution Summary: test_case_1",
                "description": "Test Execution Description",
                "startDate": "2023-01-01T12:00:00+0000",
                "finishDate": "2023-01-01T12:30:00+0000",
                "project": "TEST",
            },
            "tests": [{"testKey": "TEST-1", "comment": "test_case_1: Successful execution", "status": "PASSED"}],
        },
        {
            "info": {
                "summary": "Test Execution Summary: test_case_1",
            ...
            "tests": [{"testKey": "TEST-1", "comment": "test_case_1: Failed execution", "status": "FAILED"}],
        },
    ]
